...
# 3rd Deliverable 
Το τρίτο και τελευταίο παραδοτέο, αφορά περισσότερο τα εφέ που θα εχει το παιχνίδι και κάποιες λεπτομέρειες που θα του δώσουν την τελική του μορφή και τέλος την δομή του. Ο σχεδιασμός ακολουθεί τις οδηγίες που έχουν δοθεί γραπτώς στο GitHub και από κάποια tutorials. Πιο συγκεκριμένα, στο τρίτο παραδοτέο γίνονται τα εξής:

Πρώτα έκανα μια μικρή αλλαγή στο εύρος της κάμερας για να φαίνεται περισσότερο η πίστα.
Σημείωση: Τον εχθρό-πουλί σκόπιμα τον εχω αφήσει να μπορεί να περιστρέφει 360 μοίρες.
...
![image](https://user-images.githubusercontent.com/46854165/212314923-7980fd56-a9d1-410e-96be-131a83290f18.png)
