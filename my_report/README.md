...
Τέλος, μετά από αρκετή προσπάθεια για να καταφέρω να φτάσω μέχρι εδώ, προσάρμοσα την κάμερα (Camera - Cinemachine) να ακολουθεί τον πρωταγωνιστή, και την περιόρισα ώστε να μην φαίνεται όλη η πίστα και να την ανακαλύπτει ο παίκτης.
# 3rd Deliverable 
